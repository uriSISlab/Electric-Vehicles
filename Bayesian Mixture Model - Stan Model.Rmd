...
# Multivariate modeling accounts for the correlation between shape parameters (i.e., alpha & beta). Included random effect to allow     for individual influence of the individuals on the fitting of distributions.
```{r}
Model= 
"data {
